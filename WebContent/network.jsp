	...
	<div align="center">
		<div style="width: 1000px;">
			...
			<div id="content" align="center"
				...
				<br />
				<form method="post" action="process" enctype="multipart/form-data" onsubmit="return check()">
					<table align="center" width="900px;"
						...
						<td align="left" colspan="3" valign="top"
								...
								<h3 style="font-size: 18px;">Motif Size:</h3> 
								<input type="radio" name="msize" value="3" checked>3
								<input type="radio" name="msize" value="4">4
								<input type="radio" name="msize" value="5">5
								<input type="radio" name="msize" value="6">6
						</td>
						</tr>
						<tr>
							<td align="left" colspan="3" valign="top"
								style="font-size: 18px; font-family: Times New Roman; padding-left: 5px; padding-top: 10px; padding-right: 5px; padding-bottom: 10px; line-height: 1.5;">
								<h3 style="font-size: 18px;">Please Input Data Set: <a href="resource/data/networkmotif.txt" target="_blank">(Example Data)</a>
								</h3> 
						...
						<tr>
							<td align="left" colspan="3" valign="top"
								style="font-size: 18px; font-family: Times New Roman; padding-left: 5px; padding-top: 10px; padding-right: 5px; padding-bottom: 10px; line-height: 1.5;">
								<input type="radio" name="netmotif" value="undirected" checked>Undirected
								<input type="radio" name="netmotif" value="directed">Directed
							</td>
						</tr>
						<tr>					
							<td align="left" colspan="3" valign="top"
